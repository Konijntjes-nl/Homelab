...
#############################################################################
wget -O AlmaLinux-9-GenericCloud-latest.x86_64.qcow2 https://almalinux.mirror.liteserver.nl/9/cloud/x86_64/images/AlmaLinux-9-GenericCloud-latest.x86_64.qcow2
#############################################################################
echo modifing AlmaLinux-9-GenericCloud
#############################################################################
virt-customize -a AlmaLinux-9-GenericCloud-latest.x86_64.qcow2 --install "vim,unzip,bash-completion,wget,curl,qemu-guest-agent"
virt-customize -a AlmaLinux-9-GenericCloud-latest.x86_64.qcow2 --run-command 'systemctl enable qemu-guest-agent'
virt-customize -a AlmaLinux-9-GenericCloud-latest.x86_64.qcow2 --timezone "Europe/Amsterdam"
virt-customize -a AlmaLinux-9-GenericCloud-latest.x86_64.qcow2 --selinux-relabel
qemu-img resize AlmaLinux-9-GenericCloud-latest.x86_64.qcow2 20G
#############################################################################
#############################################################################
