...
wget -O Rocky-10-GenericCloud-Base.latest.x86_64.qcow2 \
    https://rockylinux.mirror.liteserver.nl/10/images/x86_64/Rocky-10-GenericCloud-Base.latest.x86_64.qcow2

#############################################################################
echo "Modifying cloud image (minimal install)..."
#############################################################################
IMAGE_FILE="Rocky-10-GenericCloud-Base.latest.x86_64.qcow2"
...
echo "✅ Rocky Linux 10 MINIMAL template created as VM ID $TEMPLATE_ID"
